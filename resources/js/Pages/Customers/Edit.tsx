...
export default function EditCustomer({ customer }: EditCustomerProps) {
  ...
  const [previewUrls, setPreviewUrls] = useState<{
    ...
    idCardCopy: customer.id_card_copy_path || undefined,
    guarantorIdCardCopy: customer.guarantor_id_card_copy_path || undefined,
    commercialRecordCopy: customer.commercial_record_copy_path || undefined,
  });
  ...
  const { data, setData, put, processing, errors } = useForm({
    ...
    commercialRecord: customer.commercial_record || '',
    status: customer.status || 'ACTIVE',
    registration_date: customer.registration_date || '',
    guarantorName: customer.guarantor_name || '',
    guarantorPhone: customer.guarantor_phone || '',
    guarantorId: customer.guarantor_id || '',
      ...
      if (file && file.type.startsWith('image/')) {
        ...
        setPreviewUrls(prev => {
          ...
          if (customer.id_card_copy_path) {
            newUrls.idCardCopy = customer.id_card_copy_path;
          } else {
      ...
      if (file && file.type.startsWith('image/')) {
        ...
        setPreviewUrls(prev => {
          ...
          if (customer.guarantor_id_card_copy_path) {
            newUrls.guarantorIdCardCopy = customer.guarantor_id_card_copy_path;
          } else {
      ...
      if (file && file.type.startsWith('image/')) {
        ...
        setPreviewUrls(prev => {
          ...
          if (customer.commercial_record_copy_path) {
            newUrls.commercialRecordCopy = customer.commercial_record_copy_path;
          } else {
      ...
      <div className="space-y-6 mt-2 -mx-1 sm:-mx-2 lg:-mx-3 xl:-mx-4">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            <Button variant="ghost" size="sm" onClick={() => router.visit(`/customers/${customer.id}`)}>
                  ...
                  <div className="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-4 text-center">
                    {previewUrls.idCardCopy ? (
                      <div className="space-y-2">
                        {previewUrls.idCardCopy.startsWith('blob:') || previewUrls.idCardCopy.startsWith('http') ? (
                          <img
                          ...
                          <div className="flex items-center justify-center h-32 bg-gray-100 dark:bg-gray-800 rounded border">
                ...
                <div>
                  ...
                  <div className="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-4 text-center">
                    {previewUrls.guarantorIdCardCopy ? (
                      <div className="space-y-2">
                        {previewUrls.guarantorIdCardCopy.startsWith('blob:') || previewUrls.guarantorIdCardCopy.startsWith('http') ? (
                          <img
                  ...
                  <div className="md:col-span-2">
                    ...
                    <div className="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-4 text-center">
                      {previewUrls.commercialRecordCopy ? (
                        <div className="space-y-2">
                          {previewUrls.commercialRecordCopy.startsWith('blob:') || previewUrls.commercialRecordCopy.startsWith('http') ? (
                            <img
