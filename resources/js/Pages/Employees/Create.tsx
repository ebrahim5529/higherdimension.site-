...
export default function CreateEmployee() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    post('/employees', {
      onSuccess: () => {
        showToast.success('تم الإنشاء بنجاح', 'تم إضافة الموظف بنجاح');
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900 dark:text-white">إضافة موظف جديد</h1>
              <p className="text-gray-600 dark:text-gray-400">إدخال بيانات الموظف الجديد</p>
            </div>
          </div>
        </div>
