...
export default function JournalEntryCreate({ accounts, entryNumber }: Props) {
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400 mt-1">
              رقم القيد: <span className="font-mono">{entryNumber}</span>
            </p>
          </div>
        </div>
                ...
                <table className="w-full text-sm">
                  ...
                  <tfoot>
                    <tr className="border-t-2 border-gray-300 dark:border-gray-600 font-bold">
                      <td colSpan={2} className="py-3 px-2 text-left">
                        الإجمالي
                      </td>
