...
export default function DashboardLayout({
  ...
  const pathToSectionMap = useMemo(
    () => ({
      ...
      '/dashboard/locations': 'settings-governorates',
      '/dashboard/locations/governorates': 'settings-governorates',
      '/dashboard/locations/wilayats': 'settings-wilayats',
      '/dashboard/locations/regions': 'settings-regions',
