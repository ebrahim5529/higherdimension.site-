import{r as d,j as e,a as _}from"./app-8OqINlFw.js";import{D as S,a as D}from"./dialog-BbQdauNz.js";import{B as l}from"./button-YHlBK_jD.js";import{I as P}from"./input-E8iAaKpE.js";import{s as m}from"./use-toast-Cryf2K0K.js";import{M as p}from"./message-square-Da_HMODo.js";import{X as E}from"./x-CWy3iZ8T.js";import{F as W}from"./file-text-BZukqvFc.js";import{P as A}from"./phone-iSsWr_EY.js";import{E as B}from"./eye-B4ghmYJG.js";import{D as F}from"./download-l6SQYrNq.js";import{C as I}from"./copy-DPpDKE0_.js";import{c as U}from"./createLucideIcon-BApQ4peW.js";const z=U("Send",[["path",{d:"M14.536 21.686a.5.5 0 0 0 .937-.024l6.5-19a.496.496 0 0 0-.635-.635l-19 6.5a.5.5 0 0 0-.024.937l7.93 3.18a2 2 0 0 1 1.112 1.11z",key:"1ffxy3"}],["path",{d:"m21.854 2.147-10.94 10.939",key:"12cjpa"}]]),T=({open:n,onOpenChange:i,contract:s,customerPhone:o=""})=>{const[t,c]=d.useState(o),[x,b]=d.useState(""),[g,u]=d.useState("");d.useEffect(()=>{s&&n&&(c(o),f())},[s,n,o]),d.useEffect(()=>{x.trim()?u(x):f()},[x,s]);const f=()=>{if(!s)return;const r=s.contract_type||"تأجير معدات بناء",a=typeof window<"u"?window.location.origin:"",h=s.contract_number||"",$=`${a}/contract/sign/${h}`,k=`السلام عليكم ورحمة الله وبركاته
