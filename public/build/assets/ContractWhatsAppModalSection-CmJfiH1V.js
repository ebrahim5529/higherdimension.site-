import{r as d,j as e,a as _}from"./app-CIHDT1Yw.js";import{D as S,a as D}from"./dialog-BWsYceCf.js";import{B as l}from"./button-CTRcBcRG.js";import{I as P}from"./input-DW6J3VC_.js";import{s as m}from"./use-toast-C6s0pZSX.js";import{M as p}from"./message-square-CdY6RSm0.js";import{X as E}from"./x-CklfPxUM.js";import{F as W}from"./file-text-2pLt5J22.js";import{P as A}from"./phone-J9yi97Cf.js";import{E as B}from"./eye-BfnXVWUK.js";import{D as F}from"./download-D3n7i37H.js";import{C as I}from"./copy-ac0DIdrg.js";import{c as U}from"./createLucideIcon-BJ6gPpUa.js";const z=U("Send",[["path",{d:"M14.536 21.686a.5.5 0 0 0 .937-.024l6.5-19a.496.496 0 0 0-.635-.635l-19 6.5a.5.5 0 0 0-.024.937l7.93 3.18a2 2 0 0 1 1.112 1.11z",key:"1ffxy3"}],["path",{d:"m21.854 2.147-10.94 10.939",key:"12cjpa"}]]),T=({open:n,onOpenChange:i,contract:s,customerPhone:o=""})=>{const[t,c]=d.useState(o),[x,b]=d.useState(""),[g,u]=d.useState("");d.useEffect(()=>{s&&n&&(c(o),f())},[s,n,o]),d.useEffect(()=>{x.trim()?u(x):f()},[x,s]);const f=()=>{if(!s)return;const r=s.contract_type||"تأجير معدات بناء",a=typeof window<"u"?window.location.origin:"",h=s.contract_number||"",$=`${a}/contract/sign/${h}`,k=`السلام عليكم ورحمة الله وبركاته
