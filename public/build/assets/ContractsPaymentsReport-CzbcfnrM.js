import{r as h,j as e,H as L,L as y,a as u}from"./app-BRrJ3CdV.js";import{D as P,g as $}from"./DashboardLayout-Bwzne5V9.js";import{C as n,b as p,c as j,a as l}from"./card-Dbed2lD6.js";import{B as f}from"./button-MxZB0I61.js";import{C as M}from"./combobox-DTUX61Hy.js";import{T as z,a as B,b as v,c as m,d as H,e as c}from"./table-BkO5Qm9j.js";import{F as E}from"./file-text-CaQ4QP-O.js";import{P as R}from"./printer-a1VclMRq.js";import{c as C}from"./createLucideIcon-CBX3S45X.js";/* empty css            */import"./triangle-alert-DV8hH9lH.js";import"./x--ywqLEwp.js";import"./eye-vWP_Cx7N.js";import"./shield-Fi1LtIWx.js";import"./circle-alert-D2ZYTkYp.js";import"./map-pin-DV0zeeAX.js";import"./mail-BmfIO7bn.js";import"./dialog-oS5FyKBG.js";import"./index-7ETnEXyQ.js";import"./check-KIJHshf6.js";const k=C("ExternalLink",[["path",{d:"M15 3h6v6",key:"1q9fwt"}],["path",{d:"M10 14 21 3",key:"gplh6r"}],["path",{d:"M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6",key:"a6xqqp"}]]),w="/dashboard/customer-contracts-payments-report";function re({customerOptions:g,selectedCustomerId:o,selectedCustomer:a,contracts:i}){const[d,b]=h.useState("all");h.useEffect(()=>{b("all")},[o]);const S=h.useMemo(()=>g.map(t=>({value:String(t.id),label:`${t.name} — ${t.customerNumber}${t.phone?` — ${t.phone}`:""}`})),[g]),x=h.useMemo(()=>{if(!i.length)return[];if(d==="all")return i;const t=Number(d);return i.filter(s=>s.id===t)},[i,d]),N=t=>{if(!t){u.get(w,{},{preserveScroll:!0});return}u.get(w,{customer_id:t},{preserveScroll:!0})},r=t=>new Intl.NumberFormat("en-US",{style:"currency",currency:"OMR"}).format(Number(t||0)),T=()=>new Date().toLocaleDateString("ar-SA",{year:"numeric",month:"long",day:"numeric"}),D=()=>window.print();return e.jsxs(P,{children:[e.jsx(L,{title:"تقرير عقود ومدفوعات عميل"}),e.jsx("style",{children:`
        @media print {
          @page {
            size: A4;
            margin: 14mm 12mm;
