import{r as d,j as e,a as _}from"./app-BbqYRrtx.js";import{D as S,a as D}from"./dialog-CueUNNba.js";import{B as l}from"./button-Dsr0qUEF.js";import{I as P}from"./input-r4y07TQO.js";import{s as m}from"./use-toast-D9n3N8it.js";import{M as p}from"./message-square-BoYcwhIb.js";import{X as E}from"./x-NWaNnHCk.js";import{F as W}from"./file-text-CUfyGn5_.js";import{P as A}from"./phone-D1SqX6-O.js";import{E as B}from"./eye-Dbekj9b_.js";import{D as F}from"./download-DhJEVcI8.js";import{C as I}from"./copy-Cj4uxlST.js";import{c as U}from"./createLucideIcon-dGEXd8re.js";const z=U("Send",[["path",{d:"M14.536 21.686a.5.5 0 0 0 .937-.024l6.5-19a.496.496 0 0 0-.635-.635l-19 6.5a.5.5 0 0 0-.024.937l7.93 3.18a2 2 0 0 1 1.112 1.11z",key:"1ffxy3"}],["path",{d:"m21.854 2.147-10.94 10.939",key:"12cjpa"}]]),T=({open:n,onOpenChange:i,contract:s,customerPhone:o=""})=>{const[t,c]=d.useState(o),[x,b]=d.useState(""),[g,u]=d.useState("");d.useEffect(()=>{s&&n&&(c(o),f())},[s,n,o]),d.useEffect(()=>{x.trim()?u(x):f()},[x,s]);const f=()=>{if(!s)return;const r=s.contract_type||"تأجير معدات بناء",a=typeof window<"u"?window.location.origin:"",h=s.contract_number||"",$=`${a}/contract/sign/${h}`,k=`السلام عليكم ورحمة الله وبركاته
